...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            ExpectedConditions.presenceOfElementLocated(By.xpath("//input[@class='css-b52kj1' or @placeholder='Search for items/categories']"))));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            WebElement cartParent = driver.findElement(By.xpath("//div[contains(@class,'css-1gjj37g')]"));
