...
public class SearchResult {
        ...
        try {
            ...
            for(int i=0; i< expectedTableHeaders.size(); i++){
                ...
                if(!expectedTableHeaders.get(i).equals(tempHeaderValue)){
                    System.out.println("Failures in Header Comparison: Expected: " + expectedTableHeaders.get(i) + " Actual: " + tempHeaderValue);
                    status =false;
                }
            }
            ...
            for(int i=0; i< expectedTableBody.size(); i++){
                ...
                for(int j=0; j<expectedTableBody.get(i).size(); j++){
                    ...
                    if(!expectedTableBody.get(i).get(j).equals(tempHeaderValue)){
                        System.out.println("Failures in Body Comparison: Expected: " + expectedTableBody.get(i).get(j) + " Actual: " + tempHeaderValue);  
                        status= false;  
                    }
                }
            }
    ...
    public Boolean verifyExistenceofSizeDropdown(WebDriver driver) {
        ...
        try {
            ...
            WebElement element = parentElement.findElement(By.className("css-13sljp9"));
